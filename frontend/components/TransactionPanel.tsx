...
export function TransactionPanel({
  ...
  return (
    <motion.div
      ...
      className="glass-panel flex flex-col items-center gap-4 p-6"
    >
      ...
      {state.phase === "success" && (
        <div className="flex flex-col items-center gap-2 py-4">
          ...
          <p className="text-sm font-medium text-text-primary">{successLabel}</p>
        </div>
      )}
      ...
      {state.phase === "error" && (
        <div className="flex flex-col items-center gap-2 py-4 text-center">
          ...
          <p className="text-sm font-medium text-rose">{state.error ?? "Something went wrong."}</p>
        </div>
      )}
      ...
      {state.hash && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="font-mono text-xs text-text-muted underline decoration-dotted underline-offset-4 hover:text-cyan"
        >
